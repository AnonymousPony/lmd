...
# --------------------------------------------------------
# ImageNet: https://storage.googleapis.com/kaggle-competitions-data/kaggle-v2/17433/824213/bundle/archive.zip?GoogleAccessId=web-data@kaggle-161607.iam.gserviceaccount.com&Expires=1655637728&Signature=eZY%2F7ZevAWGvPfl22F%2FphgTO86a%2BM9YhXArwEPyaEMO3xI%2BUw7LbjM7s%2BpFaJpBuC0eVyzWovu%2F7R%2BMJUmLUa3waHq%2BSSzZLnVxfzsCmtEnxs%2BbkZh6cYyvAmphZsqvEtyCsrfuY0IDNprCTDYo859JbphIt0Akfeclj6KAwpkH4J%2BUhpZ5jObKkTjVrwvHsztH10J2mbZ3I90%2FmSuA9QsMt4ET3N7vD2I46yj4lmGtzHpR9DmKAsgrQEF8RqbQliWNzBBP4Awu6kYC%2BWcO5lFnCE1ZgVdEAr1K6bqBqfT%2Bw7pJVTluyv%2FOxyNggAnf1sKksMSAYOiJbCr55sZcuFw%3D%3D&response-content-disposition=attachment%3B+filename%3Dimagenet-object-localization-challenge.zip
...
def main(args):
    ...
    if args.finetune and not args.eval:
        ...
        if args.global_pool:
            ...
            # 微调模型是VIT加了分类头，所以加载参数时只有VIT的参数，没有分类头的参数
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            vae, model, criterion, data_loader_train,
        ...
        test_stats = evaluate(vae, data_loader_val, model, device)
        print(f"Accuracy of the network on the {len(dataset_val)} test images: {test_stats['acc1']:.1f}%")
